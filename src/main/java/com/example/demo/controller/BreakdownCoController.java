...
public class BreakdownCoController {
    ...
    public String specify(@PathVariable("id") Integer bcoCcId, Model model, RedirectAttributes redirectAttributes) {
        ...
        // 対象データを取得
        Long defTotalPriceWithTax = longTotalPriceWithTax - (longTotalConstructionPrice + longTaxPrice);
        // Modelに格納
        ...
        if (targetConstructionContract != null) {
            ...
            model.addAttribute("breakdownCo",
                    service.findAllById(bcoCcId, longDirectConstructionPrice, longTotalConstructionPrice));
            model.addAttribute("listSize",
                    service.findAllById(bcoCcId, longDirectConstructionPrice, longTotalConstructionPrice).size());
    ...
    public String detail(@PathVariable("id1") Integer bcoId, @PathVariable("id2") Integer bcoCcId, Model model,
    ...
    public String create(@PathVariable("id") Integer bcoCcId, @ModelAttribute BreakdownCoForm form, Model model,
            RedirectAttributes redirectAttributes) {
    ...
    @PostMapping("/add")
    @PreAuthorize("hasAuthority('EDITOR')")
    public String add(@Validated BreakdownCoForm form, BindingResult bindingRusult, Model model,
    ...
    @PreAuthorize("hasAuthority('EDITOR')")
    public String edit(@PathVariable("id1") Integer bcoId, @PathVariable("id2") Integer bcoCcId, Model model,
            RedirectAttributes redirectAttributes) {
    ...
    @PreAuthorize("hasAuthority('EDITOR')")
    public String revice(@PathVariable("id1") Integer bcoId, @PathVariable("id2") Integer bcoCcId,
            @Validated BreakdownCoForm form, BindingResult bindingRusult, Model model,
            RedirectAttributes redirectAttributes, @AuthenticationPrincipal LoginUserDetails loginUserDetails) {
    ...
    public String remove(@PathVariable("id1") Integer bcoId, @PathVariable("id2") Integer bcoCcId, Model model,
            RedirectAttributes redirectAttributes) {
