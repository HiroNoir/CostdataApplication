...
public interface BreakdownCdService {
    ...
    /** 【登録実行】 */
    ErrorKinds insert(BreakdownCd breakdownCd, LoginUserDetails loginUserDetails);

    /** 【更新実行】 */
    ErrorKinds update(BreakdownCd breakdownCd, LoginUserDetails loginUserDetails);
